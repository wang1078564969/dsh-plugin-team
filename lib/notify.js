...
export function createNotifier(deps) {
  ...
  const stats = { delivered: 0, updated: 0, throttled: 0, suppressed: 0, digested: 0, skipped: 0, failed: 0 }
  ...
  async function runDelivery({ decision, card, chatId, target, botId }) {
    ...
    try {
      ...
      if (plan.action === 'update') stats.updated += 1
